                ...
                >
                    <View style={styles.cardview}>
                        <Image
                            ...
                            source={{ uri: item.lovepost_img }}
                        />
                        <View style={{ marginLeft: 10, justifyContent:'center' }}>
                        <Text style={[styles.text, { width: phoneWidth - 130 }]} >{item.lovepost_title}</Text>
                        <View style={{ flexDirection: 'row', justifyContent: 'space-between', marginTop: 10 }}>
                                <Text style={[styles.text,{fontSize:12}]} >{item.lovepost_name}</Text>
        ...
        return(
            ...
            <View>
                <View style={{
                    ...
                    <View>
                        <Text style={{ marginLeft: 10, fontSize: 18, fontWeight: 'bold' }}>찜목록</Text>
                    </View>
                </View>
            </View>
            <FlatList
